...
<body id="top">
<div class="bgded overlay" style="background-image: url('b.jpeg');"> 
		...
		<div class="wrapper">
			<div id="pageintro" class="hoc clear">
				<article>
					...
					<footer>
						<div>
							<h3>Choose File to Upload in Server</h3> <br />
							<form action="UploadFileServlet" method="post" enctype="multipart/form-data">
								<input type="file" name="uploadFile" size="60" style="background-color: Gray"/> <br /> <br /> <br />
								<input class="btn" name="submitBtn" type="submit" value="Size" style="padding: 100px 130px" />
								<input class="btn" name="submitBtn" type="submit" value="Variable" style="padding: 100px 130px" />
								<input class="btn" name="submitBtn" type="submit" value="Method" style="padding: 100px 130px" /><br /> <br />
