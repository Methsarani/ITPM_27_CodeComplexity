...
<body id="top">
				...
				<article>
					<div>
						<p class="heading" style="font-size: 20px">
							Join with us and get better experience.... <br>
							<br> Evaluate code due to the customer requirements 100%
							free online. No email required, completely anonymous.<br>
							<br><br>
							<br> How to convert Upload program and get code complexity: <br>
							<br>Step 1: Choose the relevant topic. <br>Step 2: Upload your file. <br>Step 3: Download your
							resolution pdf.
						</p>
					</div>
					<br><br><br><br>
	...
	<div class="btn-group">
		<button>
			<a href="SVM.jsp" style="color: white">SIZE</a>
		</button>
		<button>
			<a href="SVM.jsp" style="color: white">VARIABLE</a>
		</button>
		<button>
			<a href="SVM.jsp" style="color: white">METHOD</a>
		</button>
		<button>
