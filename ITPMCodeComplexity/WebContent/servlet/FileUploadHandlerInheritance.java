...
import services.InheritanceComplexityMain;

public class FileUploadHandlerInheritance extends HttpServlet {
		...
		try {
			...
			while (it.hasNext()) {
				...
				if (isFormField) {
					...
					String destination="C:\\Users\\Dulsa\\Documents\\ITPM\\uploads\\"+fileItem.getName();
